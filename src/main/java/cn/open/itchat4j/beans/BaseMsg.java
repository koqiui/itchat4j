package cn.open.itchat4j.beans;
...
public class BaseMsg implements Serializable {
	...
	//
	private String typeCode; // = > MsgTypeEnum.code
	...
	//
	/** 消息类型 **/
	private int msgType; // text, image, voice, video, shortvideo, link
	...
	// 语音消息 format : amr
	private String mediaId; // image, voice, video, shortvideo
	private int voiceLength;
	//
	private int playLength;
	// 视频/小视频 消息 thumbMediaId
	// 位置消息 label, location_X, location_Y, scale
	// 链接消息 title, description, url
	private String url; //
